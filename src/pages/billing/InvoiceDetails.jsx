...
const InvoiceDetails = () => {
    ...
    useEffect(()=>{
        ...
        if(account && account.billing_details){
            setFormData(account.billing_details)
        }
    },[])

    const handleSaveChanges = async () => {
        console.log('Saving form data:', formData);
        const response = await ApiService.post(`fairymailer/update-billing-details`, { ...formData }, user.jwt)
